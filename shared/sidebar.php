...
$modulos_usuario = [];
if ($permisos === 'Super Admin') {
    $modulos_usuario = [
        'dashboard','gestiones','reportes','pos','convenios','giftcard',
        'venta_diferida','estado_cuenta','portal_empresa','usuarios',
        'configuracion','locales','clientes','perfiles'
    ];
} else {
    $stmt = $mysqli->prepare(
